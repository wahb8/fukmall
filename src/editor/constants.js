...
export const MAX_LETTER_SPACING = 50
export const MAX_LINE_HEIGHT = 3
export const MAX_ASSET_LIBRARY_ITEMS = 20
...
export const MAX_STAGE_DISPLAY_WIDTH = 428
export const MAX_STAGE_DISPLAY_HEIGHT = 570
